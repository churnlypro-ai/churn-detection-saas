...
export type AuditAction = 'stripe_connected' | 'stripe_disconnected' | 'paddle_connected' | 'paddle_disconnected' | 'lemonsqueezy_connected' | 'lemonsqueezy_disconnected' | 'subscription_tier_changed' | 'referral_reward_applied' | 'prospecting_batch_sent' | 'linkedin_prospect_marked_sent' | 'instagram_prospect_marked_sent' | 'x_prospect_marked_sent' | 'billing_mode_switched' | 'performance_revenue_billed' | 'performance_invoice_failed';
