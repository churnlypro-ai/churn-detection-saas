...
export type AuditAction = 'stripe_connected' | 'stripe_disconnected' | 'subscription_tier_changed' | 'referral_reward_applied' | 'prospecting_batch_sent' | 'linkedin_prospect_marked_sent';
